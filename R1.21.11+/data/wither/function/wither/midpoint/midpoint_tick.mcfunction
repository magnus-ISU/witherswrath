...
execute if score midpoint stages matches 1 if entity @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=midpointpos,nbt={OnGround:1b}] run function wither:wither/midpoint/midpoint_ground
...
execute if entity @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=midpointpos] run schedule function wither:wither/midpoint/midpoint_tick 1t
