# ON
execute if data storage wither:options {toggledash:Disabled} as @p run schedule function wither:wither/toggle/t_dash_on 1t
...
# OFF
execute if data storage wither:options {toggledash:Enabled} as @p run schedule function wither:wither/toggle/t_dash_off 1t
