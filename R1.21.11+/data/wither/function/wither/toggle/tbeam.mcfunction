# ON
execute if data storage wither:options {togglebeam:Disabled} as @p run schedule function wither:wither/toggle/tbeamon 1t
...
# OFF
execute if data storage wither:options {togglebeam:Enabled} as @p run schedule function wither:wither/toggle/tbeamoff 1t
