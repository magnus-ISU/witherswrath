# ON
execute if data storage wither:options {toggledestruction:Disabled} as @s run schedule function wither:wither/toggle/t_destruction_on 1t
...
# OFF
execute if data storage wither:options {toggledestruction:Enabled} as @s run schedule function wither:wither/toggle/t_destruction_off 1t
