# ON
execute if data storage wither:options {toggletrophy:Disabled} as @p run schedule function wither:wither/toggle/t_trophy_on 1t
...
# OFF
execute if data storage wither:options {toggletrophy:Enabled} as @p run schedule function wither:wither/toggle/t_trophy_off 1t
