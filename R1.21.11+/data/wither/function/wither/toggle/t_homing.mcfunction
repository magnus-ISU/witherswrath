# ON
execute if data storage wither:options {togglehoming:Disabled} as @p run schedule function wither:wither/toggle/t_homing_on 1t
...
# OFF
execute if data storage wither:options {togglehoming:Enabled} as @p run schedule function wither:wither/toggle/t_homing_off 1t
