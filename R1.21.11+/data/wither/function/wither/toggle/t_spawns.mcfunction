# ON
execute if data storage wither:options {togglespawns:Disabled} as @p run schedule function wither:wither/toggle/t_spawns_on 1t
...
# OFF
execute if data storage wither:options {togglespawns:Enabled} as @p run schedule function wither:wither/toggle/t_spawns_off 1t
