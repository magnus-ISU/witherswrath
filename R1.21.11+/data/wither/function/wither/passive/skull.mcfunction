...
execute as @e[type=minecraft:wither_skull,tag=buff,limit=1,tag=buff] run data merge entity @e[type=minecraft:wither,tag=ominousWither,limit=1] {active_effects:[{id:"minecraft:resistance",amplifier:2,duration:1,show_particles:0b}]}
execute at @e[type=minecraft:wither_skull,nbt={dangerous:0b},tag=buff,limit=1] run summon creeper ~ ~-.1 ~ {Team:"Wither",ExplosionRadius:2b,Fuse:0,Tags:["boom"],CustomName:"Ominous Wither's Skull",active_effects:[{id:"minecraft:wither",amplifier:1,duration:4}],attributes:[{id:"minecraft:scale",base:0.0625}]}
...
execute as @e[type=minecraft:wither_skull,nbt={dangerous:1b},limit=1,tag=buff] run data merge entity @e[type=minecraft:wither,tag=ominousWither,limit=1] {active_effects:[{id:"minecraft:resistance",amplifier:3,duration:1,show_particles:0b}]}
execute at @e[type=minecraft:wither_skull,nbt={dangerous:1b},tag=buff,limit=1] run summon creeper ~ ~-0.1 ~ {Team:"Wither",ExplosionRadius:3b,Fuse:0,Tags:["bigboom"],CustomName:"Ominous Wither's Blue Skull",active_effects:[{id:"minecraft:wither",amplifier:3,duration:4}],attributes:[{id:"minecraft:scale",base:0.0625}]}
...
execute if entity @e[type=wither,tag=ominousWither] run schedule function wither:wither/passive/skull 1t
