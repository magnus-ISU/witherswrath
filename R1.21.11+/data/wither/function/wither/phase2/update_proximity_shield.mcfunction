...
execute as @e[type=wither,tag=ominousWither,tag=ProximityShield,limit=1] at @s unless entity @a[distance=..16] run schedule function wither:wither/phase2/proximity_shield_down 50t
