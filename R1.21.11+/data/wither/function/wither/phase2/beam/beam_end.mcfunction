...
execute if entity @e[type=wither,tag=ominousWither,scores={Health=100..}] unless entity @e[type=wither,tag=ominousWither,tag=WhiteShieldDive] run schedule function wither:wither/phase2/beam/beam_pre 60s
