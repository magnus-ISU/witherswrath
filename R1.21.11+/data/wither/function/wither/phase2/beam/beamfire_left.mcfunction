...
execute at @e[tag=beamCrystalL,limit=1] facing entity @e[tag=beamTargetCenter,limit=1] feet run function wither:wither/phase2/beam/beamraycast
...
execute if score #beam_targets beamStep matches 2.. at @e[tag=beamCrystalL,limit=1] facing entity @e[tag=beamTargetLeft,limit=1] feet run function wither:wither/phase2/beam/beamraycast
...
execute if score #beam_targets beamStep matches 3 at @e[tag=beamCrystalL,limit=1] facing entity @e[tag=beamTargetRight,limit=1] feet run function wither:wither/phase2/beam/beamraycast
