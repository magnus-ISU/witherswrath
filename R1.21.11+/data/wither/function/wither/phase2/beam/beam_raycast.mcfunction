...
execute unless block ~ ~ ~ #minecraft:replaceable run function wither:wither/phase2/beam/beam_creeper_terminal
...
execute if score #beam_steps beamStep matches 300.. run function wither:wither/phase2/beam/beam_creeper_terminal
...
execute if score #beam_spacing beamStep matches 6.. run function wither:wither/phase2/beam/beam_creeper
...
execute positioned ^ ^ ^0.5 run function wither:wither/phase2/beam/beam_raycast
